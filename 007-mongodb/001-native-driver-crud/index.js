...
(async function () {
  ...
  // const document = await collection.findOne({_id: ObjectID("5fd7bbe5fbdc7dc75d329aee")});
   ...
   */
  // const updateResult = await collection.updateOne({bar: 'qwerty'}, {$set: {foo: 42}}, {upsert: true});
