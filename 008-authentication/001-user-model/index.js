...
mongoose.connect('mongodb+srv://user:user@cluster0.oaqgz.mongodb.net/mongodb_auth?retryWrites=true&w=majority', {
  useCreateIndex: true,
...
function createSalt() {
  return randomBytesPromise(20).then(buffer => buffer.toString('hex'));
}
